...
export class Backend implements backendInterface {
    ...
    async deletePatient(arg0: string): Promise<Patient> {
    ...
    async getPatientByUid(arg0: string): Promise<Patient> {
        if (this.processError) {
            try {
                const result = await this.actor.getPatientByUid(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async register(arg0: Patient): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updatePatient(arg0: Patient): Promise<Patient> {
        if (this.processError) {
            try {
